...
class Either[L, R]:
    ...
    @custom_function(
        EitherTestCompiler(0), unitary_flags=UnitaryFlags.Dagger, effects=()
    )
    @no_type_check
    ...
    @custom_function(
        EitherTestCompiler(1), unitary_flags=UnitaryFlags.Dagger, effects=()
    )
    @no_type_check
    ...
    @custom_function(
        EitherToOptionCompiler(0), unitary_flags=UnitaryFlags.Dagger, effects=()
    )
    @no_type_check
    ...
    @custom_function(
        EitherToOptionCompiler(1), unitary_flags=UnitaryFlags.Dagger, effects=()
    )
    @no_type_check
...
@custom_function(EitherConstructor(0), unitary_flags=UnitaryFlags.Dagger, effects=())
@no_type_check
def left[L, R](val: L @ owned) -> Either[L, R]:
    """Constructs a `left` either value."""


@custom_function(EitherConstructor(1), unitary_flags=UnitaryFlags.Dagger, effects=())
@no_type_check

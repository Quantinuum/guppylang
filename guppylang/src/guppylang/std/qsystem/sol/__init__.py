...
@hugr_op(quantum_op("Reset", ext=QSYSTEM_SOL_EXTENSION), effects=())
@no_type_check
def reset(q: qubit) -> None:
    """Reset a qubit to the :math:`|0\\rangle` state."""


@hugr_op(quantum_op("QFree", ext=QSYSTEM_SOL_EXTENSION), effects=[Effect.FREE])
@no_type_check
...
@hugr_op(
    quantum_op("LazyMeasureLeaked", ext=QSYSTEM_SOL_EXTENSION), effects=[Effect.FREE]
)
@no_type_check
...
@hugr_op(quantum_op("LazyMeasure", ext=QSYSTEM_SOL_EXTENSION), effects=[Effect.FREE])
@no_type_check
...
@hugr_op(quantum_op("FutureToMeasurement", ext=QSYSTEM_SOL_EXTENSION), effects=())
@no_type_check
...
@hugr_op(quantum_op("PhasedX", ext=QSYSTEM_SOL_EXTENSION), effects=())
@no_type_check
...
@hugr_op(quantum_op("PhasedXX", ext=QSYSTEM_SOL_EXTENSION), effects=())
@no_type_check
...
@hugr_op(quantum_op("Rz", ext=QSYSTEM_SOL_EXTENSION), effects=())
@no_type_check
